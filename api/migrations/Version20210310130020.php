...
final class Version20210310130020 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE media_object (id INT AUTO_INCREMENT NOT NULL, source_id INT NOT NULL, meta JSON DEFAULT NULL, file_path VARCHAR(255) DEFAULT NULL, INDEX IDX_6A2CA10C953C1C61 (source_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, file_id INT NOT NULL, album_id INT NOT NULL, name VARCHAR(255) NOT NULL, song_artist VARCHAR(255) DEFAULT NULL, duration FLOAT DEFAULT NULL, INDEX IDX_33EDEEA193CB796C (file_id), INDEX IDX_33EDEEA11137ABCF (album_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE album ADD CONSTRAINT FK_39986E435E5ED8AD FOREIGN KEY (album_art_id) REFERENCES media_object (id)');
        $this->addSql('ALTER TABLE media_object ADD CONSTRAINT FK_6A2CA10C953C1C61 FOREIGN KEY (source_id) REFERENCES source (id)');
        ...
        $this->addSql('ALTER TABLE song ADD CONSTRAINT FK_33EDEEA193CB796C FOREIGN KEY (file_id) REFERENCES media_object (id)');
        $this->addSql('ALTER TABLE song ADD CONSTRAINT FK_33EDEEA11137ABCF FOREIGN KEY (album_id) REFERENCES album (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649E3BD8EDF FOREIGN KEY (profilepic_id) REFERENCES media_object (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media_object DROP FOREIGN KEY FK_6A2CA10C953C1C61');
