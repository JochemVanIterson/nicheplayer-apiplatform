<template lang="pug">
  q-page(padding)
    ...
    q-list(bordered separator class="rounded-borders")
      q-item(v-for="song in orderedSongs" v-if="song" :key="'songs_'+song.id" :clickable="songAllowed(song)" :disabled="!songAllowed(song)" @click="songClicked(song)")
...
export default {
  ...
  methods: {
    ...
    songClicked (song) {
      ...
      const playableIndex = this.songsPlayable.indexOf(song)
