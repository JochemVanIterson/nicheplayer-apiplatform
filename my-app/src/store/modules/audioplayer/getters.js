...
export function getPlaylist(state, getters, rootState, rootGetters) {
...
export function getIsPlaying(state, getters, rootState, rootGetters) {
    return state.isPlaying;
}

export function getPlayingIndex(state, getters, rootState, rootGetters) {
...
export function getSongObject(state, getters, rootState, rootGetters) {
    return (id) => {
...
export function getAlbumObject(state, getters, rootState, rootGetters) {
    return (id) => {
...
export function getMediaObject(state, getters, rootState, rootGetters) {
    return (id) => {
...
export function getMetaArtist (state, getters, rootState, rootGetters) {
    if (getters['getCurrentSong'].album) return getters['getCurrentSong'].album.artist
    else return ""
}

export function getMetaAlbum(state, getters, rootState, rootGetters) {
    if (getters['getCurrentSong'].album) return getters['getCurrentSong'].album.name
    return ""
}

export function getMetaTitle(state, getters, rootState, rootGetters) {
    return getters['getCurrentSong'].name
}

export function getMetaTrackNumber(state, getters, rootState, rootGetters) {
    return getters['getCurrentSong'].trackNumber
}

export function getMetaAlbumArt(state, getters, rootState, rootGetters) {
